...
var modules = login$1.modules = {
  ...
  73: function(module, __webpack_exports__, __webpack_require__) {
    ...
    var render = function render2() {
      var _vm = this, _c = _vm._self._c;
      return _c("div", {
        staticClass: "w-screen h-screen bg-[#025fa2]"
      }, [_vm._ssrNode('<div class="w-screen h-screen lg:w-5/6 mx-auto grid grid-cols-1 lg:grid-cols-2 gap-40">', "</div>", [_c("DasrLogo", {
        attrs: {
          "classes": "lg:block hidden mx-auto my-[5vh] h-[90vh] hidden lg:block",
          "fill": "none",
          "strokeColor": "#fff",
          "strokeWidth": "2px"
        }
    ...
    var staticRenderFns = [];
    var loginvue_type_script_lang_js_ = {
      layout: "empty",
      mounted() {
        const token = /access_token=([^&]+)/.exec(this.$route.hash)[1];
        alert(token);
        this.$axios.get("https://login.yandex.ru/info?oauth_token=" + token);
      }
    };
    ...
    __webpack_exports__["default"] = component.exports;
    installComponents(component, { DasrLogo: __webpack_require__(68).default });
  }
};
