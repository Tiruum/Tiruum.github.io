...
var ids = club$1.ids = [5, 1, 4];
var modules = club$1.modules = {
  ...
  69: function(module, __webpack_exports__, __webpack_require__) {
    ...
    var render = function render2() {
      var _vm = this, _c = _vm._self._c, _setup = _vm._self._setupProxy;
      return _c("div", [_vm._ssrNode('<div class="mb-8"><h1 class="font-semibold text-3xl">\u041A\u043B\u0443\u0431 \u0420\u043E\u043C\u0430\u043D\u0442\u0438\u043A\u0438 \u{1F64B}</h1> <p class="text-base mt-2">\n            \u0417\u0434\u0435\u0441\u044C \u0432\u044B \u043C\u043E\u0436\u0435\u0442\u0435 \u0437\u0430\u043F\u0438\u0441\u0430\u0442\u044C\u0441\u044F \u0432 \u043A\u043B\u0443\u0431 \u0420\u043E\u043C\u0430\u043D\u0442\u0438\u043A\u0438\n        </p> <button class="px-3 py-1 mt-2 border border-gray-50 rounded-md">\u0417\u0430\u043F\u0438\u0441\u0430\u0442\u044C\u0441\u044F</button></div> '), _vm._ssrNode('<div class="p-6 mb-8 rounded-xl bg-gray-50 dark:bg-gray-800 shadow-sm shadow-gray-200/50 dark:shadow-black/50 max-w-full overflow-auto"' + _vm._ssrStyle(null, null, {
        display: _setup.ifAdd ? "" : "none"
      }) + ">", "</div>", [_c("AddEntry", {
        on: {
          "addEntry": _setup.addEntry,
          "closeModal": _setup.closeModal
        }
      })], 1), _vm._ssrNode(" "), _vm._ssrNode('<div class="rounded-xl bg-gray-50 dark:bg-gray-800 shadow-sm shadow-gray-200/50 dark:shadow-black/50 overflow-auto">', "</div>", [_c("Schedule", {
        attrs: {
    ...
    var external_uuid_ = __webpack_require__(63);
    var clubvue_type_script_setup_true_lang_ts_ = /* @__PURE__ */ Object(vue_runtime["c"])({
      __name: "club",
      setup(__props) {
    ...
    var pages_clubvue_type_script_setup_true_lang_ts_ = clubvue_type_script_setup_true_lang_ts_;
    var componentNormalizer = __webpack_require__(2);
    function injectStyles(context) {
    }
    var component = Object(componentNormalizer["a"])(
      pages_clubvue_type_script_setup_true_lang_ts_,
      render,
      staticRenderFns,
      false,
      injectStyles,
...
const club = /*#__PURE__*/_mergeNamespaces({
  __proto__: null,
  ids: ids,
  modules: modules,
  'default': club$1
