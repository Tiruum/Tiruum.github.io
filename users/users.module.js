...
UsersModule = __decorate([
    (0, common_1.Module)({
        ...
        imports: [
            sequelize_1.SequelizeModule.forFeature([users_model_1.User, roles_model_1.Role, user_roles_model_1.UserRoles, room_entity_1.Room, entry_entity_1.Entry, wm_entry_entity_1.WmEntry]),
            roles_module_1.RolesModule,
            (0, common_1.forwardRef)(() => rooms_module_1.RoomsModule),
            (0, common_1.forwardRef)(() => auth_module_1.AuthModule),
            (0, common_1.forwardRef)(() => wm_entries_module_1.WmEntriesModule),
        ],
        exports: [
