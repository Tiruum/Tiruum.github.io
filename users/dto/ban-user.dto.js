...
__decorate([
    (0, swagger_1.ApiProperty)({ example: '123', description: 'ID пользователя, которого хотим забанить' }),
    __metadata("design:type", Number)
], BanUserDto.prototype, "userId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Мошенничество', description: 'Причина бана' }),
